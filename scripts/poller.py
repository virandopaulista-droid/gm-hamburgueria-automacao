...
review-before-publish model as Bernardino's automation.
...
def handle_partial_failure(post, plan, plan_path, now, slot_label, exc):
    ...
    notify_once(
        ...
        "novo automaticamente. Confira manualmente no Facebook/Instagram da GM Hamburgueria o que realmente foi "
...
def handle_story(post):
    ...
    if item["type"] == "image":
        ...
        folder_id = item.get("drive_folder_id") or os.environ.get("GM_STORIES_DRIVE_FOLDER_ID", "1y80nVtlJv3wqhaV_2SG7HZf3R99nk_jw")
